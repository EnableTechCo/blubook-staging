  ...
  return (
    <div className="min-h-screen md:grid md:grid-cols-[5.5rem_minmax(0,1fr)] xl:grid-cols-[16rem_minmax(0,1fr)]">
      ...
      >
        ...
        <section
          className="mx-[18px] my-6 hidden border border-white/15 border-l-[3px] border-l-sun px-3.5 py-4 xl:block"
        ...
        <footer className="hidden border-t border-white/15 px-[18px] py-4 xl:block">
