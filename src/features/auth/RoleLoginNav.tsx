...
export function RoleLoginNav({ activeRole }: { activeRole?: LoginRole }) {
  return (
    <nav aria-label="Choose a sign-in context" className="mt-3">
      ...
      <div className="mt-2 grid grid-cols-3 border-y border-[oklch(22%_0.012_60)]">
        {links.map(({ role, label }) => {
          ...
          return (
            <Link
              ...
              className={[
                "flex min-h-11 items-center justify-center border-r border-[oklch(22%_0.012_60)] px-2 font-body text-[11px] font-semibold uppercase tracking-[0.07em] transition-colors last:border-r-0",
