...
function ProviderStat({
  ...
  return (
    <div className="min-h-32 border border-ink/30 border-t-ink bg-paper-light/70 p-4 sm:p-5">
    ...
    <div className="space-y-8">
      ...
      <Section title="Pending offers" subtitle="Requests routed to you awaiting your response">
        {offers.length === 0 ? (
          ...
          <ul className="divide-y divide-ink/25 border-y border-ink/35">
      ...
      <Section title="Capabilities" subtitle="Services you are registered to deliver">
        {capabilities.length === 0 ? (
          ...
          <ul className="grid border-l border-t border-ink/30 sm:grid-cols-2 lg:grid-cols-3">
            {capabilities.map((capability, index) => (
              <li
                key={index}
                className={`flex min-h-20 items-center justify-between gap-4 border-b border-r border-ink/30 px-4 py-3 ${
      ...
      <Section title="Your requests" subtitle="Requests assigned to you or that you raised">
        <div className="border-y border-ink/35 py-1">
